            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="text-gray-400">Sale ID</p>
                            <p className="font-medium text-white">{sale.sale_id}</p>
                        </div>
                        <div>
                            <p className="text-gray-400">Total Amount</p>
                            <p className="font-medium text-green-400">Rs.{parseFloat(sale.total_amount).toFixed(2)}</p>
                        </div>
                        <div>
                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr className="border-t border-gray-700 font-semibold">
                                        ...
                                        <td className="py-4 px-6 text-green-400">Rs.{parseFloat(sale.total_amount).toFixed(2)}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
